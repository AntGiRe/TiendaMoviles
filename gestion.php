...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/tienda_moviles/style.css">
...
<!--CABECERA DEL LOGO ....-->
    ...
    <main>
      <div id="tabs" role="tablist">
        ...
        <nav>
          <div class="tab " role="tab" aria-controls="tab1-content" aria-label="Primera pestaña para insertar reparaciones de un nuevo cliente"
            tabindex="0">Insertar Reparación Cliente</div>

          <div class="tab " role="tab" aria-controls="tab2-content" aria-label="Segunda pestaña para asignarse reparaciones por parte del técnico"
            tabindex="0">Reparar pendientes</div>
        ...
        <div id="tab1-content" class="tab-content" role="tabpanel"
          aria-labelledby="tab1" aria-describedby="tab1-description">
        ...
        <div id="tab2-content" class="tab-content" role="tabpanel"
          aria-labelledby="tab2" aria-describedby="tab2-description">
        ...
        <div id="tab3-content" class="tab-content" role="tabpanel"
          aria-labelledby="tab3" aria-describedby="tab3-description">
          ...
          <div id="tab4-content" class="tab-content" role="tabpanel"
          aria-labelledby="tab4" aria-describedby="tab4-description">
        ...
        <div id="tab5-content" class="tab-content" role="tabpanel"
          aria-labelledby="tab5" aria-describedby="tab5-description">
    ...
    <script src="/tienda_moviles/tabulacion_menu.js"></script>
